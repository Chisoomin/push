...
public class Alert_Adapter extends RecyclerView.Adapter<Alert_Adapter.AlertViewHolder>{
    Context c;
    ArrayList<alert_getset> list = new ArrayList<alert_getset>();

    Alert_Adapter(ArrayList<alert_getset> list){
        this.c = c;
        this.list = list;
    }
    ...
    public AlertViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.alert_recycle, parent, false);
